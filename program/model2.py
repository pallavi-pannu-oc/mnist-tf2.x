...
for epoch in range(epochs):
  ...
  mlflow.log_metric("train_accuracy",train_accuracy.result() * 100)
  mlflow.log_metric("train_loss",train_loss.result())
  mlflow.log_metric("test_accuracy",test_accuracy.result() * 100)
  mlflow.log_metric("test_loss",test_loss.result())
